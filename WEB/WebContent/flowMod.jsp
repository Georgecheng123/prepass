...
<html>
	...
	<body>
		...
		<div id="Content-left1">
			...
			<div id="Content-bottom"><h2><a href="addFlow.jsp">添加流表</a></h2></div>
		</div>
		<div id="Content-left2">
			<img alt="1" src="img/pic1.jpeg">
			<div id="Content-bottom"><h2><a href="deleteFlow.jsp">删除流表</a></h2></div>
		</div>
		<div id="Content-left3">
			<img alt="1" src="img/pic1.jpeg">
			<div id="Content-bottom"><h2><a href="findFlow.jsp" >查看流表</a></h2></div>
		</div>
